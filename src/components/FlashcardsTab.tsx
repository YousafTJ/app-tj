    ...
    <div>
      ...
      >
        <div className={`fc-card${flipped ? " flipped" : ""}`}>
          {/* Front — spørgsmål */}
          <div className="fc-face" style={{ background: "linear-gradient(135deg, #f0eeff 0%, #ede9fe 100%)", border: "1px solid rgba(91,66,243,0.4)", boxShadow: "0 0 40px rgba(91,66,243,0.12)" }}>
