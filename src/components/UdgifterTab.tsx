...
import { Plus, Trash2, Printer, FileText, Tag } from "lucide-react";
      ...
      <div style={{ display: "grid", gridTemplateColumns: "minmax(320px,400px) 1fr", gap: 24, alignItems: "start" }}>
        ...
        <div className="uv-card-1">
          <div className="uv-card-1-inner" style={{ padding: "20px 22px" }}>
            <h2 style={{ fontSize: 15, fontWeight: 700, color: "#f4f1ee", margin: "0 0 18px", display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            {byCategory[0] && (
              <div className="uv-card-1">
                <div className="uv-card-1-inner" style={{ padding: "18px 20px" }}>
                  ...
                  <p style={{ fontSize: 18, fontWeight: 800, color: "#f4f1ee", lineHeight: 1.2 }}>
                  ...
                  {[...byCategory].sort((a, b) => b.total - a.total).map(c => (
                    <div key={c.name}>
                      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                        ...
                        <span style={{ fontSize: 12, color: "#f4f1ee", fontWeight: 600 }}>{fmt(c.total)}</span>
                      </div>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 2 }}>
                          <span style={{ fontSize: 14, fontWeight: 600, color: "#f4f1ee" }}>{e.name}</span>
                          <span style={{
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
                        <span style={{ fontSize: 16, fontWeight: 800, color: "#f4f1ee" }}>
                          {fmt(e.price)}
                        </span>
                        <button
                          onClick={() => startEdit(e)}
          ...
          {filtered.length > 0 && (
            <div style={{
              ...
              <span style={{ fontSize: 18, fontWeight: 800, color: "#f4f1ee" }}>
