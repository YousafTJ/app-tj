    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, alignItems: "start" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div className="uv-card-1">
            <div className="uv-card-1-inner" style={{ padding: 24 }}>
              <h3 style={{ fontSize: 15, fontWeight: 700, color: "#1c1917", marginBottom: 16, margin: "0 0 16px" }}>
                Indkomst
              </h3>
          ...
          <div className="uv-card-1">
            <div className="uv-card-1-inner" style={{ padding: 24 }}>
              <h3 style={{ fontSize: 15, fontWeight: 700, color: "#1c1917", margin: "0 0 16px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div className="uv-card-1">
            <div className="uv-card-1-inner" style={{ padding: 24 }}>
              <h3 style={{ fontSize: 15, fontWeight: 700, color: "#1c1917", margin: "0 0 4px" }}>Detaljeret beregning</h3>
