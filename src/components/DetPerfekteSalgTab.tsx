...
const SCENARIOS: Scenario[] = [
  // ── SCENARIO 1: DYR COMPUTER ──────────────────────────────────────────────
  {
    id: "computer",
    emoji: "💻",
    title: "Opsalg: MacBook → Lenovo Yoga",
    subtitle: "B2C butikssalg — Opsalg fra MacBook til Lenovo Yoga, Intel Core Ultra 7 258V, 32 GB RAM",
    color: "#a78bfa",
    customer: "Maria, 34 år, freelance grafisk designer",
    product: "Lenovo Yoga — Intel Core Ultra 7 258V, 32 GB RAM, 1 TB M.2 NVMe SSD, 14\" OLED WUXGA",
    phases: [
      {
        id: "moede",
        emoji: "🤝",
        title: "Mødet & åbningen",
        context: "Maria er gået ind i elektronikbutikken. Hun kigger direkte på MacBook Pro-reolen og virker besluttet. Du har observeret hende i 2 minutter. Din opgave: Gå hen til hende uden at starte med 'kan jeg hjælpe dig?' — og find ud af HVORFOR hun vil have en MacBook, før du overhovedet nævner alternativer.",
        lines: [
          { speaker: "scene", text: "Maria kigger på en MacBook Pro display-model. Du nærmer dig afslappet." },
          { speaker: "sælger", text: "Hej! Det ser ud som om du ved præcis hvad du leder efter?", badge: "Observationsbaseret åbning — ikke 'kan jeg hjælpe?'", badgeColor: "#a78bfa" },
          { speaker: "kunde", text: "Ja, jeg vil have en MacBook Pro. Jeg er designer, alle bruger Mac" },
          { speaker: "sælger", text: "Fedt — og det giver god mening. Hvad arbejder du med til daglig?", badge: "Anerkend — grav derefter", badgeColor: "#a78bfa" },
          { speaker: "kunde", text: "Grafisk design og videoanimation. Photoshop, After Effects, Premiere" },
          { speaker: "sælger", text: "Tungt renderingsarbejde — hvad kører du i dag?", badge: "Demonstrér faglig viden", badgeColor: "#a78bfa" },
          { speaker: "kunde", text: "MacBook Pro 2019, 16 GB. Den er ved at give op" },
          { speaker: "sælger", text: "Hvad er det der frusterer dig mest ved den?", badge: "Åbn op for pain — lad kunden tale", badgeColor: "#a78bfa" },
          { speaker: "kunde", text: "Den er for langsom til rendering og overheater konstant" },
          { speaker: "scene", text: "Du har fundet smerten. Produktet er ikke nævnt endnu — du lytter stadig." },
        ],
        insights: [
          "Kunden siger 'alle bruger Mac' — det er en antagelse, ikke et behovsargument. Grav dybere.",
          "Anerkend valget (MacBook) med det samme. Modstand tidligt lukker samtalen.",
          "Din eneste opgave nu: forstå hvad der frustrerer dem ved i dag — ikke hvad de tror de vil have.",
        ],
      },
      {
        id: "lytning",
        emoji: "👂",
        title: "Aktiv lytning — afdæk den virkelige pain",
        context: "Maria er overbevist om at hun vil have en MacBook. Din opgave er IKKE at sælge Lenovo endnu — det er at lytte så grundigt at hun selv opdager hvad hun egentlig har brug for. Brug spejling, labeling og 3-sekunders pauser til at grave smerten frem.",
        lines: [
          { speaker: "sælger", text: "Overheater konstant... hvad sker der præcist når det sker?", badge: "Spejling + spørg ind", badgeColor: "#818cf8" },
          { speaker: "kunde", text: "Den throttler ned og rendering tager evigheder. En 2-minutters video tager 45 minutter" },
          { speaker: "sælger", text: "45 minutter per render...?", badge: "Spejling — gentag med undren", badgeColor: "#818cf8" },
          { speaker: "kunde", text: "Bogstaveligt talt. Og jeg kan ikke gøre andet imens — den låser sig fast" },
          { speaker: "scene", text: "[Du nikker langsomt, holder 3 sekunders pause]" },
          { speaker: "sælger", text: "Det lyder som om du mister rigtig meget arbejdstid på det", badge: "Labeling — sæt ord på følelsen", badgeColor: "#818cf8" },
          { speaker: "kunde", text: "Ja, og batteriet er også gået. 2 timer max nu. Jeg sidder hos kunder — det er pinligt" },
          { speaker: "sælger", text: "Arbejder du meget rundt — caféer, kunder, hjemmekontor?", badge: "Kortlæg arbejdsmønsteret", badgeColor: "#818cf8" },
          { speaker: "kunde", text: "Ja, alle tre steder. Fleksibilitet er alt for mig" },
          { speaker: "sælger", text: "Og bruger du nogen sinde touchscreen eller stylus til skitser og layouts?", badge: "Planter frø — afdæk latent behov", badgeColor: "#818cf8" },
          { speaker: "kunde", text: "Nej, min Mac har jo ikke det... men jeg har faktisk tænkt på at det ville være smart til klientpræsentationer" },
          { speaker: "scene", text: "Kunden har selv nævnt touchscreen som et ønske. Du har ikke solgt noget endnu." },
        ],
        insights: [
          "Spejling: gentag de 2-3 sidste ord. Kunden uddyber og afslører dybere smerte frivilligt.",
          "3-sekunders pausen efter kunden stopper: de tilføjer næsten altid noget ekstra — og det ekstra er guld.",
          "Touchscreen: nævn det som et afklarende spørgsmål. Kunden opdager selv at de vil have det.",
          "70/30-reglen: Maria har talt 70% — du 30%. Det er aktiv lytning i praksis.",
        ],
      },
      {
        id: "behov",
        ...
        context: "Nu bruger du SPIN til at gøre smerten synlig og kvantificerbar. Du graver dybere i renderingstiden, batteritabet og manglende touchscreen — og lader kunden selv beregne hvad det koster dem. Endnu intet alternativ er nævnt.",
        lines: [
          { speaker: "scene", text: "SPIN-S: Situationsspørgsmål — bekræft konteksten hurtigt" },
          { speaker: "sælger", text: "Hvilke programmer kører du typisk alle på én gang?", badge: "SPIN-S: Situation", badgeColor: "#38bdf8" },
          { speaker: "kunde", text: "Photoshop, Illustrator, Premiere, After Effects og Chrome med 15-20 tabs" },
          { speaker: "sælger", text: "Og RAM — ved du hvad din nuværende har?", badge: "SPIN-S: Teknisk kontekst", badgeColor: "#38bdf8" },
          { speaker: "kunde", text: "16 GB. Jeg har hørt at det måske er for lidt?" },
          { speaker: "scene", text: "SPIN-P: Problemspørgsmål — bekræft og forstørr smerten" },
          { speaker: "sælger", text: "Hvad sker der konkret med After Effects og Premiere når de kører samtidig?", badge: "SPIN-P: Problem", badgeColor: "#f59e0b" },
          { speaker: "kunde", text: "Det crasher eller bliver ekstremt langsomt. Jeg har lært at lukke alt ned, render én ting ad gangen" },
          { speaker: "sælger", text: "Én ting ad gangen — hvor meget ekstra tid bruger du på det workflow om dagen?", badge: "SPIN-P: Kvantificér friktionen", badgeColor: "#f59e0b" },
          { speaker: "kunde", text: "Nok halvanden time bare på at vente og skifte frem og tilbage" },
          { speaker: "scene", text: "SPIN-I: Implikationsspørgsmål — gør konsekvensen synlig i kroner" },
          { speaker: "sælger", text: "1,5 time om dagen — som freelancer, hvad ville du ellers bruge den tid på?", badge: "SPIN-I: Forstør implikationen", badgeColor: "#f87171" },
          ...
          { speaker: "kunde", text: "8-15.000 gennemsnitligt" },
          { speaker: "sælger", text: "Så din nuværende computer koster dig reelt 8-15.000 kroner om måneden i tabt omsætning?", badge: "SPIN-I: Kunden regner selv ud", badgeColor: "#f87171" },
          { speaker: "kunde", text: "Wow... det har jeg faktisk aldrig tænkt over sådan" },
          { speaker: "scene", text: "SPIN-N: Need-Payoff — lad kunden male drømmescenariet selv" },
          { speaker: "sælger", text: "Hvis rendering, overheating og batteriet bare ikke var et problem — hvad ville det ændre for din forretning?", badge: "SPIN-N: Kunden beskriver løsningen", badgeColor: "#4ade80" },
          { speaker: "kunde", text: "Jeg kunne levere hurtigere, tage flere projekter, og præsentere professionelt ude hos kunder" },
          { speaker: "sælger", text: "Og du nævnte touchscreen ville gøre klientpræsentationer bedre — er det noget du bruger aktivt?", badge: "SPIN-N: Aktivér det latente behov", badgeColor: "#4ade80" },
          { speaker: "kunde", text: "Ja, det ville faktisk gøre en stor forskel. Jeg tegner skitser med kunder" },
          { speaker: "scene", text: "Kunden har nu selv beskrevet præcis det Lenovo Yoga løser. Du har stadig ikke nævnt det." },
        ],
        insights: [
          "16 GB RAM til After Effects + Premiere + Photoshop + Chrome = systemet dør. Kunden ved det — SPIN gør det synligt.",
          "SPIN-I er magien: kunden siger selv 8-15.000 kr./md. i tab. Du behøver aldrig forsvare prisen på Lenovo.",
          "Touchscreen var et latent behov — kunden vidste ikke de ville have det, før du spurgte.",
          "Kunden sælger nu løsningen til sig selv. Din job er at lytte og bekræfte.",
        ],
      },
      {
        id: "relation",
        emoji: "💬",
        title: "Relationsopbygning & service promise",
        context: "Relationen bygges IGENNEM hele samtalen. Her er et naturligt øjeblik der opstår, og en service promise der er afgørende — fordi du er ved at anbefale noget andet end det kunden kom efter. Tillid er alt.",
        lines: [
          { speaker: "scene", text: "Du ser en nøglering med en lille tegning. Tøv ikke." },
          { speaker: "sælger", text: "Er det en håndtegnet nøglering? Er det noget du selv har lavet?", badge: "Ægte nysgerrighed", badgeColor: "#fb923c" },
          { speaker: "kunde", text: "[smiler] Ja! Jeg laver altid små skitser til mine logokoncepter på papir først" },
          { speaker: "sælger", text: "Det er faktisk ret fedt at du gør det. Det fortæller mig noget om din arbejdsproces.", badge: "Brug det aktivt — vend det til indsigt", badgeColor: "#fb923c" },
          { speaker: "kunde", text: "[nysgerrig] Hvad mener du?" },
          { speaker: "sælger", text: "[smiler] Det vender vi tilbage til om lidt. [naturlig pause]", badge: "Plant nysgerrighed — skab forventning", badgeColor: "#fb923c" },
          { speaker: "scene", text: "Service promise — afgørende fordi du er ved at udfordre kundens forforståelse" },
          { speaker: "sælger", text: "Maria, jeg vil gerne sige noget ærligt inden vi går videre", badge: "Accusation Audit — afvæbn skepsis", badgeColor: "#fb923c" },
          { speaker: "kunde", text: "Okay?" },
          { speaker: "sælger", text: "Du kom ind med en klar idé om MacBook — og det er et godt produkt. Jeg er ikke her for at tale dig fra noget. Men ud fra alt du har fortalt mig om rendering, RAM, batteri og præsentationer hos kunder — der er faktisk en computer der løser det hele bedre. Og jeg vil vise dig den. Og du bestemmer selv bagefter.", badge: "Service promise — rådgiver ikke sælger", badgeColor: "#fb923c" },
          { speaker: "kunde", text: "...okay, vis mig hvad du tænker på" },
          { speaker: "scene", text: "Kunden er åben. Tilliden er etableret. Du kan nu præsentere Lenovo Yoga uden at det føles som et angreb på hendes valg." },
        ],
        insights: [
          "Service promise er afgørende her — du udfordrer hendes plan. Uden tillid lukker hun ned.",
          "Accusation Audit: nævn selv det kunden frygter ('jeg er ikke her for at tale dig fra MacBook'). Det afvæbner forsvaret.",
          "Nøgleringen åbnede en naturlig bro til hendes arbejdsproces — brug detaljerne du ser.",
          "Plant nysgerrighed ('det vender vi tilbage til') — hun vil nu selv vide hvad du mener.",
        ],
      },
      {
        id: "pitch",
        emoji: "💡",
        title: "Pitch & præsentation — Lenovo Yoga opsalget",
        context: "Nu præsenterer du Lenovo Yoga Pro 9 med 32 GB RAM og Intel Core Ultra 7. Ikke features — fordele der løser præcis de problemer Maria selv beskrev. Hvert punkt kobles til hendes egne ord. Afslut med MMM der gør prisen ubetydelig mod det hun mister.",
        lines: [
          { speaker: "scene", text: "Du fører Maria hen til Lenovo Yoga display-modellen." },
          { speaker: "sælger", text: "Det her er Lenovo Yoga — Intel Core Ultra 7 258V, 32 GB RAM, 1 TB NVMe SSD og 14\" OLED-touchscreen. Lad mig fortælle dig præcis hvorfor den passer til det du beskrev.", badge: "Pitch baseret på kundens egne ord", badgeColor: "#a78bfa" },
          { speaker: "sælger", text: "Du sagde Photoshop, Illustrator, Premiere og After Effects kører samtidig og låser din maskine. 32 GB RAM — dobbelt af hvad du har nu — betyder at alle fire programmer kører fuldt ud på én gang. Ingen shutdown, ingen ventetid.", badge: "Problem 1: RAM → benefit", badgeColor: "#a78bfa" },
          { speaker: "kunde", text: "32 GB... det er dobbelt af hvad jeg har nu" },
          { speaker: "sælger", text: "Præcis. Og Intel Core Ultra 7 258V er Intels nyeste arkitektur — den er specifikt bygget til vedvarende tung belastning. Den throttler ikke ned, den overheater ikke. After Effects-renders der tager 45 minutter på din 2019-model? Det er 5-8 minutter på den her.", badge: "Problem 2+3: Chip → rendering + overheating løst", badgeColor: "#a78bfa" },
          { speaker: "kunde", text: "5-8 minutter? Seriøst?" },
          { speaker: "sælger", text: "Ja. Og fordi det er en Copilot+ PC med Ultra 7 258V, har den dedikeret AI-acceleration — det betyder at Premiere og After Effects faktisk bruger AI-funktioner til at speede exports op automatisk.", badge: "Bonus: Copilot+ AI-acceleration", badgeColor: "#a78bfa" },
          { speaker: "sælger", text: "OLED-skærmen er 14 tommer, WUXGA — 1920x1200. Det er en bredere billedformat end standard widescreen, perfekt til design-arbejde. Farverne er kalibreret til professionelt brug.", badge: "OLED → designerfordel", badgeColor: "#a78bfa" },
          { speaker: "sælger", text: "Og du husker du sagde du tegner skitser på papir til dine logokoncepter? [vender computeren om] Touchscreen. Du kan tegne direkte i Illustrator hos kunden — og vise dem designet live.", badge: "Latent behov: touchscreen → wow-moment", badgeColor: "#a78bfa" },
          { speaker: "kunde", text: "Det... det havde jeg faktisk ikke tænkt på var muligt på en laptop" },
          { speaker: "scene", text: "MMM: gør prisen lille i forhold til den tabte omsætning hun selv kvantificerede" },
          { speaker: "sælger", text: "Prisen er 18.999 kroner. Og lad os sætte det i perspektiv med det du selv regnede ud.", badge: "MMM — Make Money Minimal", badgeColor: "#a78bfa" },
          { speaker: "sælger", text: "Du sagde computeren koster dig 8.000 om måneden i tabt omsætning. Lenovo over 5 år er 317 kroner om måneden. Du betaler 317 — og tjener 8.000 ekstra. Det er 25 gange pengene tilbage.", badge: "Brug kundens egne tal", badgeColor: "#a78bfa" },
          { speaker: "sælger", text: "Og den er 6.000 kroner billigere end den MacBook du kom ind for at købe — og den løser problemerne MacBook ikke ville have løst.", badge: "Direkte sammenligning — bedre og billigere", badgeColor: "#a78bfa" },
          { speaker: "kunde", text: "Vent — den er billigere og mere kraftfuld?" },
          { speaker: "sælger", text: "Til det du laver: ja. MacBook M3 er fantastisk til mange ting. Men 32 GB RAM, OLED-touchscreen og Core Ultra 7 258V giver dig mere for pengene til præcis det du beskrev.", badge: "Ærlig sammenligning — ikke MacBook-bashing", badgeColor: "#a78bfa" },
        ],
        insights: [
          "Kobl hvert feature direkte til hendes egne ord: 'Du sagde X — her er præcis hvorfor det løser X.'",
          "Touchscreen var et latent behov — præsenter det som et wow-moment, ikke et salgsargument.",
          "Ærlig sammenligning: ros MacBook, men vær specifik om hvorfor Lenovo vinder på hendes behov.",
          "MMM: 317 kr./md. vs. 8.000 kr./md. i tabt omsætning. Kunden kan ikke logisk sige nej.",
        ],
      },
      {
        id: "indvendinger",
        ...
        context: "Maria har tre klassiske indvendinger: 'men jeg kender Mac', 'Windows er besværligt' og 'skal tænke over det'. Alle tre håndteres med LAER + Feel-Felt-Found. Aldrig gå i forsvar — anerkend altid først.",
        lines: [
          { speaker: "scene", text: "Indvending 1: Vane og Mac-økosystem" },
          { speaker: "kunde", text: "Men jeg har brugt Mac i 10 år... jeg kender ikke Windows" },
          { speaker: "sælger", text: "Det er en helt reel bekymring — 10 år er lang tid, og det er ikke ligegyldigt.", badge: "LAER-L+A: Lyt og anerkend", badgeColor: "#f59e0b" },
          { speaker: "sælger", text: "Jeg forstår at det føles som et stort skifte.", badge: "LAER-A: Anerkend + Empati", badgeColor: "#f59e0b" },
          { speaker: "sælger", text: "Hvad er det specifikt ved Mac du er bange for at miste — er det programmet, filen, eller bare måden den fungerer?", badge: "LAER-E: Efterforsk", badgeColor: "#f59e0b" },
          { speaker: "kunde", text: "Mest arbejdsgangen... jeg ved bare hvor alting er på Mac" },
          { speaker: "sælger", text: "Det giver fuldstændig mening. Mange af mine kunder der skiftede fra Mac til Windows 11 sagde det samme — og de fandt ud af at Photoshop, Illustrator og Premiere er 1:1 identiske på begge platforme. Det er Adobe-genvejene du kender — ikke Mac.", badge: "Feel-Felt-Found — matchende profil", badgeColor: "#f59e0b" },
          { speaker: "sælger", text: "Og Windows 11 er i dag langt mere intuitivt end for 5 år siden. De fleste siger de var komfortabel inden for en uge.", badge: "LAER-R: Reager med fakta", badgeColor: "#f59e0b" },
          { speaker: "kunde", text: "Hmm... det vidste jeg faktisk ikke om Adobe-programmerne" },
          { speaker: "scene", text: "Indvending 2: Kompatibilitet med andre Apple-enheder" },
          { speaker: "kunde", text: "Men jeg har iPhone og iPad — alt snakker jo bare sammen med Mac" },
          { speaker: "sælger", text: "Ja, AirDrop og Handoff er smarte. Det forstår jeg godt.", badge: "Anerkend det reelle benefit ved Mac", badgeColor: "#f59e0b" },
          { speaker: "sælger", text: "Hvad er det konkret du bruger AirDrop til i dit arbejde?", badge: "Find hvad der faktisk bruges", badgeColor: "#f59e0b" },
          { speaker: "kunde", text: "Egentlig bare til at sende billeder og filer hurtigt" },
          { speaker: "sælger", text: "Det løser Google Drive eller Dropbox i dag — og de virker på alle enheder. Det er ikke noget du mister i praksis.", badge: "Nedlæg indvendingen med konkret løsning", badgeColor: "#f59e0b" },
          { speaker: "scene", text: "Indvending 3: Skal tænke over det" },
          { speaker: "kunde", text: "Jeg tænker jeg tager hjem og sover på det" },
          { speaker: "sælger", text: "Selvfølgelig — det er en stor beslutning. Hvad er det præcist du vil tænke over?", badge: "Find den REELLE indvending", badgeColor: "#f59e0b" },
          { speaker: "kunde", text: "Om det er det rigtige skifte fra Mac..." },
          { speaker: "sælger", text: "Forstår det. Du nævnte du har en stor kampagne om 3 uger. Hvad sker der med renderingstiden på din nuværende computer hvis du starter den i morgen?", badge: "Urgency gennem pain — ikke pres", badgeColor: "#f59e0b" },
          { speaker: "kunde", text: "[pause] ...den tager stadig 45 minutter per render" },
          { speaker: "sælger", text: "Og hvad er din plan B hvis den crasher på dag 3 af kampagnen?", badge: "Plan B-close", badgeColor: "#f59e0b" },
          { speaker: "kunde", text: "Jeg har ingen plan B. Det har du egentlig ret i." },
        ],
        insights: [
          "Mac-vane: Kunden er bange for det ukendte — ikke for Windows. Adressér det specifikke, ikke det generelle.",
          "Adobe-programmer er identiske på begge platforme — det er din stærkeste pointe mod vane-indvendingen.",
          "AirDrop-indvendingen: spørg hvad de faktisk bruger det til. Det er sjældent noget Google Drive ikke kan.",
          "Urgency: status quo er ikke neutral. Den gamle computer koster dem 8.000 kr./md. Hjem at sove = endnu en måned tabt.",
        ],
      },
      {
        id: "closing",
        emoji: "✅",
        title: "Closing",
        context: "Maria er klar. Brug trinvis close med tre ja'er, alternativ close på betaling. Lenovo er 6.000 kr. billigere end MacBook — brug det aktivt. Afslut med naturligt upsell på tilbehør.",
        lines: [
          { speaker: "scene", text: "Trial close — temperaturcheck" },
          { speaker: "sælger", text: "Ud fra alt vi har gennemgået — rendering, RAM, touchscreen, batteriet — føler du at Lenovo Yoga løser det du kom ind for at løse?", badge: "Trial close", badgeColor: "#4ade80" },
          { speaker: "kunde", text: "Ja, det synes jeg faktisk den gør" },
          { speaker: "sælger", text: "Og til dine klientpræsentationer med touchscreen og stylus — tror du det ville gøre en forskel i forhold til i dag?", badge: "Bekræft det latente behov", badgeColor: "#4ade80" },
          { speaker: "kunde", text: "Ja, absolut. Det er faktisk ret fedt" },
          { speaker: "scene", text: "Trinvis close — tre ja'er leder naturligt til det fjerde" },
          { speaker: "sælger", text: "Og givet at du har kampagnen om 3 uger — giver det mening at sikre sig den rigtige maskine nu i stedet for at rende på 45 minutter per fil hele måneden?", badge: "Urgency naturligt indlejret", badgeColor: "#4ade80" },
          { speaker: "kunde", text: "Ja, det giver meget god mening" },
          { speaker: "scene", text: "Alternativ close + pris-reminder" },
          { speaker: "sælger", text: "Fedt. Og husk — du er faktisk 6.000 kroner billigere end den MacBook du kom ind for. Vil du betale på én gang, eller vil du bruge vores 0%-finansiering over 12 måneder — det er under 1.600 kroner om måneden?", badge: "Alternativ close — begge er ja + pris-win", badgeColor: "#4ade80" },
          { speaker: "kunde", text: "Finansieringen giver mest mening" },
          { speaker: "sælger", text: "Perfekt. Og mens vi finder papirerne — har du en stylus til touchscreenen? Vi har Lenovo Active Pen 3 der er designet specifikt til den model. Og en sleeve der passer perfekt.", badge: "Naturligt upsell", badgeColor: "#4ade80" },
          { speaker: "kunde", text: "Ja, vis mig gerne det" },
          { speaker: "scene", text: "Salget er lukket. Maria forlader butikken med Lenovo Yoga Pro 9, Active Pen og sleeve — 6.000 kr. billigere end hun planlagde, og med en computer der løser alle hendes problemer. Du solgte aldrig en laptop. Du løste hendes problemer." },
        ],
        insights: [
          "Trinvis close: tre ja'er (løser behovene → touchscreen → nu) gør det fjerde ja logisk.",
          "Pris-win: hun er 6.000 kr. billigere end sin plan. Nævn det som del af alternativ close.",
          "Alternativ close: 'På én gang eller finansiering?' — begge svar er et ja. Ingen ja/nej.",
          "Upsell ALTID naturligt efter close — stylus til touchscreen er et oplagt og relevant tilbehør.",
        ],
      },
    ],
  },
    ...
    phases: [
      ...
      },
      {
        ...
        lines: [
          ...
          { speaker: "sælger", text: "Det er den indvending jeg hører mest — og det er en reel risiko. Må jeg dele hvad vi har lært virker?", badge: "LAER-A: Anerkend + Empati", badgeColor: "#f59e0b" },
          { speaker: "kunde", text: "Ja, gerne" },
    ...
    phases: [
      ...
      },
      {
        ...
        lines: [
          ...
          { speaker: "sælger", text: "Det er en legitim bekymring — migrationer kan gå galt. Hvad er din konkrete frygt — datatab, nedetid, eller tid?", badge: "LAER-E: Efterforsk", badgeColor: "#f59e0b" },
    ...
    phases: [
      ...
      },
      {
        ...
        lines: [
          ...
          { speaker: "sælger", text: "Men hvad valgte I at renovere stuen for — hvad var målet med det?", badge: "LAER-E: Efterforsk", badgeColor: "#f59e0b" },
