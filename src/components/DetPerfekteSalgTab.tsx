    ...
    phases: [
      ...
      },
      {
        ...
        lines: [
          ...
          { speaker: "sælger", text: "Jeg forstår at det føles som et stort skifte.", badge: "LAER-E: Empati", badgeColor: "#f59e0b" },
          { speaker: "sælger", text: "Hvad er det specifikt ved Mac du er bange for at miste — er det programmet, filen, eller bare måden den fungerer?", badge: "LAER-E: Find den reelle årsag", badgeColor: "#f59e0b" },
